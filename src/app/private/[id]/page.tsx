...
import { MapIcon, DownloadIcon, LockIcon } from "lucide-react";

const APP_STORE_URL = "https://apps.apple.com/us/app/golf-playbook/id1557162395";

export default function PrivatePlaybookPage({
  params,
}: {
          ...
          <CardContent className="flex flex-col items-center gap-6 p-8">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                This is a private playbook. Only the owner can access it in the
                Golf Playbook app.
              </p>
            </div>
